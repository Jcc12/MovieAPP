...
public class LoginActivity extends AppCompatActivity {
    ...
    {
        mySocket = (SocketForAll) LoginActivity.this.getApplication();
        try {
        ...
        new android.os.Handler().postDelayed(
                new Runnable() {
                    public void run() {
                       ...
                       else if(mySocket.code == 2){
                            progressDialog.dismiss();
                            onLoginFailed_ID();
                        }
                        else if(mySocket.code == 3){
                            progressDialog.dismiss();
                            onLoginFailed_pwd();
                        }
                        else if(mySocket.code == 4){
                            progressDialog.dismiss();
